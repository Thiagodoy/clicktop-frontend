...
const routes = new Router({
  path: '/', component: App, redirect: '/inicio', name:'home',
  children: [
     { name: 'home', path: 'inicio', component: Home, display: 'home' },
     { name: 'login', path: 'login', component: Login, display: 'login' },
     { name: 'register', path: 'cadastro', component: Register, display: 'register' },
  ]
})
